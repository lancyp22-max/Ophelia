...
copy_if_exists "$ROOT_DIR/visitors.html" "$OUT_DIR/"
copy_if_exists "$ROOT_DIR/repository-links.js" "$OUT_DIR/"
copy_if_exists "$ROOT_DIR/public-repository.json" "$OUT_DIR/"
copy_if_exists "$ROOT_DIR/demos/guest-preview.html" "$OUT_DIR/demos/"
copy_if_exists "$ROOT_DIR/demos/guest-preview.js" "$OUT_DIR/demos/"
copy_if_exists "$ROOT_DIR/demos/guest-preview-state.js" "$OUT_DIR/demos/"
copy_if_exists "$ROOT_DIR/docs/guest-preview.md" "$OUT_DIR/docs/"
copy_if_exists "$ROOT_DIR/tests/guest-preview.test.mjs" "$OUT_DIR/tests/"
...
copy_if_exists "$ROOT_DIR/data/operations/choice-receipt.v1.schema.json" "$OUT_DIR/data/operations/"
copy_if_exists "$ROOT_DIR/data/operations/sample-choice-receipt.v1.json" "$OUT_DIR/data/operations/"
copy_if_exists "$ROOT_DIR/data/operations/implemented-live-registry.v1.json" "$OUT_DIR/data/operations/"
...
copy_if_exists "$ROOT_DIR/docs/agent-work-observability.md" "$OUT_DIR/docs/"
...
copy_if_exists "$ROOT_DIR/scripts/check_agent_work_observability.py" "$OUT_DIR/scripts/"
...
copy_if_exists "$ROOT_DIR/demos/mirror10-flora-phase-shift.html" "$OUT_DIR/demos/"
copy_if_exists "$ROOT_DIR/demos/world-bridge-map.html" "$OUT_DIR/demos/"
copy_if_exists "$ROOT_DIR/demos/world-3d-blockout.html" "$OUT_DIR/demos/"
