...
rm -rf "$OUT_DIR"
mkdir -p "$OUT_DIR/docs" "$OUT_DIR/policies" "$OUT_DIR/scripts" "$OUT_DIR/data/reasoning-loops" "$OUT_DIR/data/visual-state" "$OUT_DIR/data/context" "$OUT_DIR/data/decision-boundaries"
